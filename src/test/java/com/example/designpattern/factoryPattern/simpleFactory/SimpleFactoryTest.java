...
package com.example.designpattern.factoryPattern.simpleFactory;

import com.example.designpattern.factoryPattern.simpleFactory.constant.RouJiaMoConstant;
import com.example.designpattern.factoryPattern.simpleFactory.factory.SimpleRouJiaMoFactory;
import com.example.designpattern.factoryPattern.simpleFactory.product.RouJiaMo;
import com.example.designpattern.factoryPattern.simpleFactory.store.RouJiaMoStore;
